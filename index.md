...
<div style="display: flex; gap: 2rem; align-items: flex-start; flex-wrap: wrap;">
  ...
  <div style="flex: 1; min-width: 300px;">
    <p>Have you ever wondered how the universe began? What are the most fundamental building blocks of matter? My research delves into the mysteries of the cosmos, exploring the fundamental forces that shaped our existence.</p>
    <p>By combining advanced machine learning techniques with cutting-edge physics, I am analyzing the cosmic microwave background to determine the initial matter distribution at the Big Bang. This will give us clear insights into the conditions of the early universe and the formation of large-scale structures. I am also using Neural Networks to probe the proton under extreme conditions in which the quark-gluon plasma is formed and fully saturated with gluons, revealing the intricate dynamics of matter.</p>
